...
---
On November 2017, [the Grafana plugin to monitor your Azure services was announced](https://azure.microsoft.com/en-us/blog/monitor-azure-services-and-applications-using-grafana/) in Preview.  
...
az container create \
 ...
 --ip-address public \
 --ports 3000 \
 -e GF\_INSTALL\_PLUGINS=grafana-azure-monitor-datasource
 ```
